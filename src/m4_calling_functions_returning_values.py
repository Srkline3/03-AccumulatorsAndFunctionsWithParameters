...
def run_test_digits_in_cube():
    ...
    # Test 2:
    expected = 8
    actual = digits_in_cube(5)
    print('Test 2 expected: ', expected)
    print('       actual: ', actual)

    # Test 3:
    expected = 0
    actual = digits_in_cube(0)
    print('Test 3 expected: ', expected)
    print('       actual: ', actual)
...
def run_test_digits_in_power():
    ...
    # Test 1
    expected = 13
    actual = digits_in_power(2, 8)
    print('Test 1 expected: ', expected)
    print('       actual: ', actual)

    # Test 2
    expected = 1
    actual = digits_in_power(3, 0)
    print('Test 2 expected: ', expected)
    print('       actual: ', actual)

    # Test 3
    expected = 0
    actual = digits_in_power(0, 99999999)
    print('Test 3 expected: ', expected)
    print('       actual: ', actual)
